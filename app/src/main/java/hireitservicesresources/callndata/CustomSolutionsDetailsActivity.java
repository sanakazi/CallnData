...
public class CustomSolutionsDetailsActivity extends AppCompatActivity {

    TextView amt,txt_desc;
    Button btn_hire;
    EditText bs_name,bs_email,bs_phone;
    Spinner spinner_technology;
    CheckBox checkbox_customize;
    ArrayList<String> arr_productNum,arr_productName,arr_productCph,arr_productCm,arr_productBrief;
    static String catID;
    private static String TAG = CustomSolutionsDetailsActivity.class.getSimpleName();
    public static Double amt_total,amt_cph,amt_customizationMultiply = 1.0;
    int product_pos;
    String message;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_custom_solutions_details);
        ...
        checkbox_customize= (CheckBox)findViewById(R.id.checkbox_customize);
        amt_total =0.0;


        amt_customizationMultiply=1.0;
        ...
        arr_productCm= (ArrayList<String>)b.getStringArrayList("array_prodCm");
        ...
        checkbox_customize.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if (((CheckBox) v).isChecked())
                { amt_customizationMultiply= Double.parseDouble(arr_productCm.get(product_pos));
                    calculation();
                }
                else
                {
        ...
        btn_hire.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(CustomSolutionsDetailsActivity.this, "Please enter all the fields", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    {
        Log.d(TAG, "amt_cph = " + amt_cph +  " ,amt_time_unit= " + amt_customizationMultiply);
        amt_total = amt_cph *amt_customizationMultiply;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, urlJsonObj1,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(CustomSolutionsDetailsActivity.this,error.toString(),Toast.LENGTH_LONG).show();
                        hidepDialog();
                    }
                }){
            @Override
    ...
    private void launchPayPalPayment() {
        ...
        Intent intent = new Intent(CustomSolutionsDetailsActivity.this, PaymentActivity.class);
    ...
    private void showDialogToOpen() {
        ...
        dialog = new Dialog(CustomSolutionsDetailsActivity.this);
    ...
    private void autoclose()
    {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent i = new Intent(CustomSolutionsDetailsActivity.this, MainActivity.class);
